...
exports.addUser = function(user, cb) {
	...
	var sql = 'CALL api_add_user("' + user.user_name + '", "' + user.password + '", "' + user.full_name + '", "' + user.address_line_1 + '", "' + user.address_line_2 + '", "' + user.address_city + '", "' + user.address_province_code + '", "' + user.cell_no + '");';
	ns.logger.info('SQL:' + sql);
...
exports.updateUser = function(user, cb) {
	...
	var sql = 'CALL api_update_user(' + user.id + ', "' + user.password + '", "' + user.full_name + '", "' + user.address_line_1 + '", "' + user.address_line_2 + '", "' + user.address_city + '", "' + user.address_province_code + '", "' + user.cell_no + '");';
	ns.logger.info('SQL:' + sql);
